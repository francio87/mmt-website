...
const it = {
  ...
  territory: {
    kicker: 'Territorio',
    title: 'Prosegui la giornata nella valle del Metauro',
    intro: 'Dopo l’affaccio sulla forra, le Marmitte possono diventare il punto di partenza per conoscere Fossombrone e il paesaggio della valle del Metauro: storia romana, architettura rinascimentale e un’altra gola scavata dall’acqua.',
    stops: [
      { title: 'Fossombrone, dall’antica Forum Sempronii', text: 'Fossombrone è il principale centro della media valle del Metauro. Il suo nome richiama Forum Sempronii, l’abitato romano sorto lungo la Flaminia nell’area di San Martino del Piano; il centro attuale si è poi sviluppato sul colle che domina la valle.', alt: 'Panorama di Fossombrone', credit: { author: 'Toni Pecoraro', sourceLabel: 'Fossombrone panorama', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Fossombrone.jpg', license: 'Pubblico dominio', licenseUrl: 'https://commons.wikimedia.org/wiki/File:Fossombrone.jpg' } },
      { title: 'Portici, corti e ponte sul Metauro', text: 'Corso Garibaldi attraversa il cuore della città con portici e palazzi storici. Tra i luoghi da considerare, verificando aperture e disponibilità, ci sono la Corte Alta, la Corte Bassa e il Ponte della Concordia, che collega le due rive del Metauro.', alt: 'Corso Garibaldi a Fossombrone', credit: { author: 'Alicudi', sourceLabel: 'Corso Garibaldi, Fossombrone', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Fossombrone_Corso_Garibaldi.jpg', license: 'CC BY-SA 3.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/3.0/deed.it' } },
      { title: 'La Gola del Furlo', text: 'La Gola del Furlo è stata incisa dal fiume Candigliano tra il monte Pietralata e il monte Paganuccio. Dal 2001 l’area è una riserva naturale statale: è una tappa da scegliere con calma, verificando prima percorsi, condizioni e servizi.', alt: 'Veduta della Gola del Furlo', credit: { author: 'Mirko Marchetti', sourceLabel: 'Gola del Furlo', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Gola_del_Furlo.jpg', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0/deed.it' } },
      { title: 'La Via Flaminia e la galleria romana', text: 'La via Flaminia attraversa il Furlo. Nel punto più stretto della gola si trova una galleria romana attribuita all’età di Vespasiano: un segno concreto del rapporto tra questo passaggio naturale e le vie storiche dell’Italia centrale.', alt: 'Ingresso sud della galleria del Furlo', credit: { author: 'AlMare', sourceLabel: 'Furlo Tunnel South', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Furlo_Tunnel_South.jpg', license: 'CC BY-SA 2.5', licenseUrl: 'https://creativecommons.org/licenses/by-sa/2.5/deed.it' } }
    ],
    sources: { label: 'Approfondimenti storici e geografici', links: [['Fossombrone su Wikipedia', 'https://it.wikipedia.org/wiki/Fossombrone'], ['Gola del Furlo su Wikipedia', 'https://it.wikipedia.org/wiki/Gola_del_Furlo']] }
  },
  faq: {
